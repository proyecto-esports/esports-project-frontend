    ...
    <>
      ...
      >
        ...
        <ModalContent
          ...
          backGroundImage={'https://www.transparenttextures.com/patterns/notebook.png%22'}
        >
          <ModalHeader>
            <svg
              width="50%"
            ...
            >
              <g clipPath="url(#clip0_52_363)">
                ...
                <path
                  ...
                  fill={theme.dark.background}
                />
                <path d="M100 51.99H84V65.72H100V51.99Z" fill={theme.dark.background} />
              </g>
              <defs>
                <clipPath id="clip0_52_363">
                  <rect width="451" height="108.25" fill={theme.dark.primary} />
                </clipPath>
              </defs>
            </svg>
          </ModalHeader>
          ...
          <ModalBody>
            <Text>
              ...
              top of your league.
              <break>On the tab bar, down the screen, you will be able to: </break>
              <ul
                style={{
              ...
              >
                <li>
                  Visit your lineup and make changes with players on your bench (you will
                  see the bench players by clicking on one player in your lines).
                </li>{' '}
                <li>
                  Visit the market to bid for new players; you can not see the bids of
                  your adversaries, so you will have to guess and try.
                </li>
                <li>Stay put on the ranking to see who is leading! </li>
                <li>
                  On the ranking site, as an Admin of the League, you will find a button
                  to manage the moment of the games, renew the market and distribute the
                  points.
                </li>
                <li>
                  <bold>As an Administrator</bold> of the League, you will have all the
                  Justice on your hands; <strong>be fair</strong>.
                </li>
                <li>
                  One user becomes Administrator of one League by just creating one.
                </li>
              </ul>
              As a team manager, you will win points by having the most successful lineup
              on your side. To do so, you will have to fight on the market by bidding the
              highest for the players that will appear weekly; but be careful! Money is a
              limited resource at the beginning of your career. Play smart and line up
              your team as best as you can. The fight for the Gold is about to start!
            </Text>
          </ModalBody>
